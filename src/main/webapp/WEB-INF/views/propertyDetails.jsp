  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <form class="d-flex" action="${pageContext.request.contextPath }/search" method="Get">
        <input name="keyword" id="keyword" value="${keyword}" class="form-control me-2" type="search" placeholder="Search by province,type,faced..." aria-label="Search" required>
...
<div>
<label>Sort By:</label>
<a class="btn btn-primary" href="${pageContext.request.contextPath }/getsortedhousebyprice" role="button" style="float:none;margin-right:2px">Increasing Price </a>
<a class="btn btn-primary" href="${pageContext.request.contextPath }/getsortedhousebypricedes" role="button" style="float:none;margin-right:2px">Decreasing Price </a>
</div>
...
<c:if test="${home.validatedata== true }"> 
	
<div class="card" style="width: 80%;height:450px;margin-left:130px; padding:10px;margin-bottom:10px;">
  <img src="${pageContext.request.contextPath }/property_image/${home.houseImage[0] }" class="card-img-top" alt="..." style="height:100%;overflow:hidden;">
   ...
   <div class="content" >
                ...
                <div class="buttons">
                    <a href="${pageContext.request.contextPath }/onedetail/${home.id}" class="btn"  style="float:left;">view details</a>
